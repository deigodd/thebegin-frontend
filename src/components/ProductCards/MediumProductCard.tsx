...
const MediumProductCard: React.FC<ProductCardProps> = ({ product }) => {
    ...
    return (
        <div className="bg-white rounded-sm shadow-md flex px-4 py-5 w-full max-w-lg scale-90 transition-transform duration-300 transform hover:scale-90 sm:hover:scale-105 hover:shadow-lg sm:scale-95">
            <img 
                src={imageUrl} 
                alt={name} 
