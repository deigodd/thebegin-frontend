...
const TheBeginCard: React.FC<ProductCardProps> = ({ product }) => {
    ...
    return (
        <div className="relative group bg-white w-full h-full overflow-hidden">
            <div className="grid object-cover w-full h-full group-hover:translate-y-[-20%] transition-transform duration-500 ease-in-out"
                style={{
                ...
                <div className="bg-tbc-secondarybrown-200 rounded-lg px-4 w-full h-36 translate-y-full group-hover:scale-90 duration-700 ease-in-out self-end">
                    <div className="mt-2">
                        <h3 className="text-gray-800 text-md font-medium">{name}</h3>
