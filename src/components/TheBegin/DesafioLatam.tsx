...
const DesafioLatam: React.FC = () => {
  ...
  const content: string =
    ...
    return (
      <div className="2xl:flex items-center bg-white cursor-pointer overflow-hidden">
        {/* Contenedor del video */}
        <div className="relative 2xl:w-1/3 flex-grow">
          <video
            src={latamVideo}
            loop
            autoPlay
        ...
        <div className="px-12 text-justify 2xl:w-2/3 mt-4 2xl:mt-0">
