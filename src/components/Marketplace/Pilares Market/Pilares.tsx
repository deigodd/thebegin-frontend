  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 space-y-4">
      <div className="flex flex-col md:flex-row gap-4">
        <div className="md:w-1/4 relative aspect-[3/4] bg-gradient-to-b from-purple-200 to-purple-100 rounded-lg overflow-hidden">
          <img
            src="/placeholder.svg"
            alt="Arte con sentido"
            className="object-cover w-full h-full"
          />
          <div className="absolute inset-0 flex items-end p-6 bg-gradient-to-t from-purple-900/70 to-transparent">
            <h1 className="text-3xl font-bold text-white">Arte con sentido</h1>
          </div>
        </div>
        <div className="md:w-3/4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex gap-2 bg-purple-900 text-white h-auto p-1 overflow-x-auto flex-nowrap rounded-lg">
              <button className="px-4 py-2 bg-purple-700 rounded-lg focus:outline-none">ÚLTIMOS PRODUCTOS</button>
              <button className="px-4 py-2 text-white hover:bg-purple-700 rounded-lg">DESTACADOS</button>
              <button className="px-4 py-2 text-white hover:bg-purple-700 rounded-lg">MÁS VISITADOS</button>
            </div>
