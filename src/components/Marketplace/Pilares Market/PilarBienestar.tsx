      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="md:w-3/4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex gap-2 bg-tbc-pilarorange-600 text-white h-auto p-1 overflow-x-auto flex-nowrap rounded-lg">
              <button className="px-4 py-2 bg-tbc-pilarorange-600 rounded-lg focus:outline-none">ÚLTIMOS PRODUCTOS</button>
              <button className="px-4 py-2 bg-tbc-pilarorange-400 text-white hover:bg-tbc-pilarorange-100 rounded-lg">DESTACADOS</button>
              <button className="px-4 py-2 bg-tbc-pilarorange-200 text-white hover:bg-tbc-pilarorange-100 rounded-lg">MÁS VISITADOS</button>
            </div>
        ...
        <div className="md:w-1/4 relative aspect-[3/4] bg-gradient-to-b from-tbc-pilarorange-600 to-tbc-pilarorange-200 rounded-lg overflow-hidden">
          <img
            src="/placeholder.svg"
            alt="Arte con sentido"
            className="object-cover w-full h-full"
          />
          <div className="absolute inset-0 flex items-end p-6 bg-gradient-to-t from-tbc-pilarorange-200 to-transparent">
