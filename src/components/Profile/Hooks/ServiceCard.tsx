...
export const ServiceCard: React.FC<ServiceCardProps> = ({ data }) => {
    ...
    return (
        <div className="relative overflow-hidden rounded-lg shadow-md bg-[#f3f0ea] border border-[#d8d4ce] transition-transform hover:scale-105">
            <div className="aspect-square relative  rounded-lg">
                ...
                />
                <div className="absolute inset-0 bg-tbc-secondarygreen-600 group-hover:bg-white/50 transition-colors duration-300 rounded-md" />
