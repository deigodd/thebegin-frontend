    ...
    <footer className="bg-[#a56441] ">
      <div className="mx-auto w-full max-w-screen-xl">
        ...
        <div className="px-4 py-6 bg-[#7D4B31]  md:flex md:items-center md:justify-between">
          <span className="text-sm text-white/80 dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/" className="hover:text-[#FFFFFF]">The Begin™</a>. All Rights Reserved.
          </span>
