...
export default function FestivalPage() {
  return (
    <main
      className="min-h-screen bg-tbc-primaryred-100 text-white"
      style={{
    ...
    >
      ...
      <section className="container mx-auto px-4 py-12">
        <h1 className="text-5xl font-bold font-serif text-tbc-primarybrown-600 text-center mb-8">
          The Begin Fest
        </h1>
        <div
        ...
        >
          <div>
            <strong>Begin Fest</strong> es una jornada <strong>única</strong>,
            un espacio diseñado para que las mujeres nos{" "}
            <strong>
              encontremos físicamente, nos conozcamos, nos abracemos y nos
              inspiremos
            </strong>
            , intercambiemos nuestras habilidades, expongamos y vendamos
            nuestros productos…, es una fiesta del cuidado y bienestar de
            mujeres para mujeres. Este festival brinda una plataforma{" "}
            <strong>diversa e inspiradora</strong> que incluye:
          </div>
        </div>
