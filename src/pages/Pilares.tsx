...
const Pilares: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`fixed-navbar ${!isNavbarFixed ? "hidden-navbar" : ""}`}
        >
          <Navbar />
        </div>
        ...
        <div className="relative bg-white border border-gray-200 mt-10 mb-10 h-auto pt-20 flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start justify-center pl-6 md:pl-16 pr-6 md:pr-12 py-6">
            ...
            <p className="text-black text-sm md:text-lg leading-relaxed">
              Nuestra plataforma como es un match colaborativo que destaca por
              su asertividad principal basada en coincidencias. Nos referimos
              específicamente al match centrado en elementos como profesión u
              ocupación, modelos de negocio, intereses particulares y
              necesidades de información y preferencias de interacción
              específicas.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center mx-auto w-full max-w-7xl min-w-[320px] min-h-[760px] h-auto lg:mt-4 pt-1 pb-4 space-y-2">
